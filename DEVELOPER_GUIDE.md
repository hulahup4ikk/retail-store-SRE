...
- `src/`: application services, service charts, compose files, and shared deployment assets
- `terraform/`: AWS infrastructure modules and shared Terraform libraries
- `monitoring/`: Prometheus, Alertmanager, Grafana, and local observability stack files
- `ansible/`: automation for host bootstrap, Swarm deployment, monitoring deployment, and EKS rollout
- `deploy/docker-swarm/`: Docker Swarm stack assets for the end-term project
- `docs/`: architecture notes, SLOs, incident response, and capacity-planning documents
